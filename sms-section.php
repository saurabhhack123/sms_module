    ...
    <div class="row-fluid navbar">
		  <div class="navbar-inner">
		    ...
		    <ul class="nav">
		      ...
		      <li class="active"><a href="#">Send Sms to Section</a></li>
...
?>
	...
	<div class="row-fluid">
	   <div class="act-box">
              <div class="control-group fix-sec-head">
				    <div class="controls">
				       <select id="msg-typ">
		      ...
		      <div class="controls btn-sms">
                         <button class="btn btn-primary" type="button" id="sms-section" data-loading-text="sending sms to class students....." data-role="button">Send Sms to Whole Section</button>
		      </div>
       </div>  
    </div> 
