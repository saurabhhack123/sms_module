    ...
    <div class="row-fluid navbar">
		  <div class="navbar-inner">
		    ...
		    <ul class="nav">
		      ...
		      <li class="active"><a href="#">Send Sms to Class </a></li>
...
$sms_model_class  = new SmsClass($schoolid);
$message_type_map = $sms_model_class->message_type;
$classes          = $sms_model_class->get_classes();

?>
	<div class="row-fluid">
	   <div class="act-box">
              <div class="control-group fix-cls-head">
				    <div class="controls">
				       <select id="msg-typ">
		      ...
		      <div class="controls btn-sms">
                         <button class="btn btn-primary" type="button" id="sms-class" data-loading-text="sending sms to class students....." data-role="button" >Send Sms to Whole Class</button>
		      </div>
       </div>  
    </div> 
